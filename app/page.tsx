            ...
            <div>
              <a className="flex items-center" href="/">
                <Image
                  ...
                  className=" rounded"
                  src="/vaidikecosystems.png"
                  alt="vaidikecosystems logo"
                  width={160}
                  height={160}
                  priority
                />
        ...
        <div className=" backdrop-blur-[2px] h-[4rem] flex items-center">
          <footer className="mx-auto w-full max-w-7xl px-4 md:px-6 lg:px-8 flex items-center justify-center gap-4 md:text-xl font-inter text-[#8a8a8e]">
            ...
            <a
              ...
              href="https://www.vaidikecosystems.com/"
              target="_blank"
            >
            www.vaidikecosystems.com
            </a>
            <a
              className="text-base font-semibold"
              href="https://www.vaidikecosystems.com/contact/"
              target="_blank"
            >
              contact us
            </a>
